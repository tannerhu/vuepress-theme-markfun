<template>
  <div :key="this.$page.path">
    <main class="page">

      <div :class="`theme-markfun-wrapper ${bgStyle}`">
        <ModuleTransition delay="0.02" >
        <ArticleInfo v-if="isArticle()" />
        </ModuleTransition>
        <ModuleTransition delay="0.04">
        <component
          class="theme-markfun-content"
          v-if="pageComponent"
          :is="pageComponent"
        />
        </ModuleTransition>
        <ModuleTransition delay="0.04">
        <div class="content-wrapper" style="transform: translateZ(10px)">
          ...
          <Content class="theme-markfun-content" />
        </div>
        </ModuleTransition>
...
import PageEdit from '@theme/layouts/components/PageEdit.vue'
import PageNav from '@theme/layouts/components/PageNav.vue'
...
.page
  ...
  >*
    @extend $markfun-wrapper
.theme-markfun-wrapper
  .content-wrapper
    position relative
  h1 img
