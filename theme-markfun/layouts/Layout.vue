...
<script>
import Home from '@theme/layouts/components/Home.vue'
import Navbar from '@theme/layouts/components/Navbar.vue'
import Page from '@theme/layouts/components/Page.vue'
import CategoriesPage from '@theme/layouts/components/CategoriesPage.vue'
import TagsPage from '@theme/layouts/components/TagsPage.vue'
import ArchivesPage from '@theme/layouts/components/ArchivesPage.vue'
import Sidebar from '@theme/layouts/components/Sidebar.vue'
import Buttons from '@theme/layouts/components/Buttons.vue'
import Footer from '@theme/layouts/components/Footer'
import BodyBgImg from '@theme/layouts/components/BodyBgImg'
